...
GLint _Scene::initGL()
{
    ...
    // skybox
    skyBox->boxInit();
    skyBox->myTex[0].loadTexture("images/ProjectSkyboxes/Steampunk_Box_Back.png");
    skyBox->myTex[1].loadTexture("images/ProjectSkyboxes/Steampunk_Box_Front.png");
    skyBox->myTex[2].loadTexture("images/ProjectSkyboxes/Steampunk_Box_Top.png");
    skyBox->myTex[3].loadTexture("images/ProjectSkyboxes/Steampunk_Box_Bottom.png");
    skyBox->myTex[4].loadTexture("images/ProjectSkyboxes/Steampunk_Box_Left.png");
    skyBox->myTex[5].loadTexture("images/ProjectSkyboxes/Steampunk_Box_Right.png");
    // HUD
    ...
    gameWinPanel->initIcon("images/transition/lvl1complete.png");
    ...
    // player model
    player->init("models/doomguy/tris.md2", "models/doomguy/red.pcx", "models/doomguy/w_shotgun.md2", "models/doomguy/w_shotgun.pcx");
    player->pos.x = 0.0f;
    player->pos.y = 0.0f;
    player->pos.z = 0.0f;
    player->yaw = 0.0f;
