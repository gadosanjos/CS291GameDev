#ifndef _SCENEVIRTUALWORLD_H
#define _SCENEVIRTUALWORLD_H
...
class _SceneVirtualWorld : public IScene
{
    public:
        _SceneVirtualWorld();
        virtual ~_SceneVirtualWorld();
        ...
        vec3 mouse;
        char* song = "sounds/Horizons.mp3";
    protected:
    private:
        std::chrono::steady_clock::time_point lastTime;
};
#endif // _SCENEVIRTUALWORLD_H
