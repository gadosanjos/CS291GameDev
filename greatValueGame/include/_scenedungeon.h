#ifndef _SCENEDUNGEON_H
#define _SCENEDUNGEON_H
...
class _SceneDungeon : public IScene
{
public:
    _SceneDungeon();
    virtual ~_SceneDungeon() override;
